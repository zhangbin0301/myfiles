...
if source /root/env.yml; then
  ...
  splithttp="vless://${UUID}@${MYIP}:${SPLIT_PORT}?path=%2Fsplithttp&security=tls&encryption=none&alpn=h3&host=${MYIP}&type=splithttp&sni=${MYIP}#${country_abbreviation}-${SUB_NAME}-splithttp"
